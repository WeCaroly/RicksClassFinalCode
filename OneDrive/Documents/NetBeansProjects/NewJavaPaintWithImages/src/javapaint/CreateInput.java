...
implements MouseListener, MouseMotionListener, MouseWheelListener {
   ...
   public CreateInput( Component component ) {
   ...
   private void centerMouse() {
    ...
    public synchronized int mouseWheelMoved( MouseWheelEvent e, int actionCode ) {
       int notche = e.getWheelRotation();
                if (notche < 0) { // up
                    actionCode += getNotches();
                }
   return actionCode;
   }
