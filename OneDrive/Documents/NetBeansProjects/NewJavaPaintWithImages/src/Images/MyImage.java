...
public class MyImage extends WritableImage{
    ...
    private double colorDistance(Color thisColor, Color possibleColor) {
        
        //L1
        double rDistance = Math.abs(thisColor.getRed()-possibleColor.getRed());
        double gDistance = Math.abs(thisColor.getGreen()-possibleColor.getGreen());
        double bDistance = Math.abs(thisColor.getBlue()-possibleColor.getBlue());
        
        double totalDistance = rDistance+gDistance+bDistance;
        //double totalDistance = Math.sqrt(rDistance+gDistance+bDistance);
